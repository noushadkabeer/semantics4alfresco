 ...
 * modified to handle calais integreation semantic tag/category search
 * 
...
function getSearchResults(params)
{
   ...
   else if (semanticTag !== null && semanticTag.length !== 0)
   {
      ...
      if (semanticCategory !== null && semanticCategory.length !== 0)
      {
         ...
         ftsQuery = 'PATH:\"/cm:semantictaggable/cm:' + escapedSemanticCat + '/cm:' + escapedTagName + '//*\"';                                          
      }   
      else
      {
         ftsQuery = 'PATH:\"/cm:semantictaggable//cm:' + escapedTagName + '//*\"';  
      }
   }   
