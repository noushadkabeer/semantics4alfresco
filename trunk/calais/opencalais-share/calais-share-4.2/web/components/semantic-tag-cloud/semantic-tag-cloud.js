...
/**
 * Semantic Tag Cloud component.
 * 
 * @namespace Alfresco
 * @class Alfresco.dashlet.SemanticTagCloud
 */
(function()
{
   /**
   ...
   var PREFERENCES_DASHLET = "org.alfresco.share.dashlet",
      PREF_SITE_TAGS_FILTER = PREFERENCES_DASHLET + ".SemanticTagCloudFilter";


   /**
    * Dashboard SemanticTagCloud constructor.
    * 
    * @param {String} htmlId The HTML id of the parent element
    * @return {Alfresco.dashlet.SemanticTagCloud} The new component instance
    * @constructor
    */
   Alfresco.dashlet.SemanticTagCloud = function SemanticTagCloud_constructor(htmlId)
   {
      return Alfresco.dashlet.SemanticTagCloud.superclass.constructor.call(this, "Alfresco.dashlet.SemanticTagCloud", htmlId);
   };

   /**
    * Extend from Alfresco.component.Base and add class implementation
    */
   YAHOO.extend(Alfresco.dashlet.SemanticTagCloud, Alfresco.component.Base,
   {
      /**
       ...
       * @method onReady
       */
      onReady: function SemanticTagCloud_onReady()
      {
         var me = this;
         ...
         {
            this.widgets.filter.value = "Company";
       ...
       * @method refreshTags
       */
      refreshTags: function SemanticTagCloud_refreshTags()
      {
       ...
       */
      onTagsSuccess: function SemanticTagCloud_onTagsSuccess(p_response)
      {
       ...
       * @method onTagsFailed
       */
      onTagsFailed: function SemanticTagCloud_onTagsFailed()
      {
       ...
       */
      getUriTemplate: function SemanticTagCloud_getUriTemplate(tag)
      {
         ...
         {
            case "City":
               uri += '&amp;semanticCategory=City';
               break;

            case "Company":
               uri += '&amp;semanticCategory=Company';
               break;

            case "Organization":
               uri += '&amp;semanticCategory=Organization';
               break;
       ...
       */
      updateFilterUI: function SemanticTagCloud_updateFilterUI()
      {
         switch (this.options.activeFilter)
         {
            case "all":
       ...
       */
      setActiveFilter: function SemanticTagCloud_setActiveFilter(filter, noPersist)
      {
       ...
       */
      onAllCheckedChanged: function SemanticTagCloud_onAllCheckedChanged(p_oEvent, p_obj)
      {
         this.setActiveFilter("all");
       ...
       */
      onFilterClicked: function SemanticTagCloud_onFilterClicked(p_oEvent)
      {
       ...
       */
      onFilterChanged: function SemanticTagCloud_onFilterChanged(p_oMenuItem)
      {
