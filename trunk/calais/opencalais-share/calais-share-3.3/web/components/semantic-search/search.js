...
(function()
{
   ...
   Alfresco.Search.prototype =
   {
      ...
      onReady: function Search_onReady()
      {
         ...
         var uriSearchResults = Alfresco.constants.PROXY_URI + "semantics/search?";
      ...
      onSearch: function Search_onSearch(layer, args)
      {
         ...
         if (obj !== null)
         {
            ...
            this._performSearch(searchTerm, searchTag, searchAll, searchSemanticTag, searchSemanticCategory);
         }
      },
       ...
       */
      _performSearch: function Search__performSearch(searchTerm, searchTag, searchAll, searchSemanticTag, searchSemanticCategory)
      {
         var searchTerm = YAHOO.lang.trim(searchTerm);
         var searchTag = YAHOO.lang.trim(searchTag);

         var searchSemanticTag = YAHOO.lang.trim(searchSemanticTag);
         var searchSemanticCategory = YAHOO.lang.trim(searchSemanticCategory);
         ...
         this.widgets.dataSource.sendRequest(this._buildSearchParams(searchAll, searchTerm, searchTag, searchSemanticTag, searchSemanticCategory),
         {
       ...
       */
      _buildSearchParams: function Search__buildSearchParams(searchAll, searchTerm, searchTag, searchSemanticTag, searchSemanticCategory)
      {
         var site = searchAll ? "" : this.options.siteId;
         var params = YAHOO.lang.substitute("site={site}&term={term}&tag={tag}&semanticTag={semanticTag}&semanticCategory={semanticCategory}&maxResults={maxResults}",
         {
