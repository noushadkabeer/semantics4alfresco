...
<#-- Custom Auto Tag Action -->
<@link rel="stylesheet" type="text/css" href="${page.url.context}/components/auto-tag/auto-tag-action.css" />
<@script type="text/javascript" src="${page.url.context}/components/auto-tag/auto-tag-action.js"></@script>