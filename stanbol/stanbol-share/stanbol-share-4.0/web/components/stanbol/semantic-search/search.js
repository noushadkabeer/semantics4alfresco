...
(function()
{
   ...
   YAHOO.extend(Alfresco.Search, Alfresco.component.Base,
   {
      ...
      _performSearch: function Search__performSearch(args)
      {
         ...
         this.widgets.dataSource.sendRequest(this._buildSearchParams(searchAll, searchTerm, searchTag, searchSort, searchSemanticTag, searchSemanticCategory),
         {
       ...
       */
      _buildSearchParams: function Search__buildSearchParams(searchAll, searchTerm, searchTag, searchSort, searchSemanticTag, searchSemanticCategory)
      {
         var site = searchAll ? "" : this.options.siteId;
         var params = YAHOO.lang.substitute("site={site}&term={term}&tag={tag}&semanticTag={semanticTag}&semanticCategory={semanticCategory}&maxResults={maxResults}&sort={sort}&query={query}",
         {
