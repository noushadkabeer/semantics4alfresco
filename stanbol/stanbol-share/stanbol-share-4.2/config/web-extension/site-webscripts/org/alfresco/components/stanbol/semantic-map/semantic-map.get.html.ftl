<@markup id="css" >
   <#-- CSS Dependencies -->
   <@link rel="stylesheet" type="text/css" href="${url.context}/res/components/stanbol/semantic-map/semantic-map.css" group="dashlets" />
</@>
...
<@markup id="js">
   ...
   <@script type="text/javascript" src="${url.context}/res/components/stanbol/semantic-map/semantic-map.js" group="dashlets"></@script>
</@>
