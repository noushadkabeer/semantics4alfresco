...
(function()
{
   ...
   YAHOO.extend(Alfresco.Search, Alfresco.component.SearchBase,
   {
      ...
      options:
      {
         ...
         initialSearchSemanticTag: "",
    
         initialSearchSemanticCategory: "",                     
      ...
      onReady: function Search_onReady()
      {
         ...
         var uriSearchResults = Alfresco.constants.PROXY_URI_RELATIVE + "semantics/stanbol/search?";
         ...
         YAHOO.Bubbling.fire("onSearch",
         {
            ...
            searchSemanticTag: this.options.initialSearchSemanticTag,
            searchSemanticCategory: this.options.initialSearchSemanticCategory               
         });
      ...
      onSearch: function Search_onSearch(layer, args)
      {
         ...
         if (obj !== null)
         {
            ...
            var searchSemanticTag = this.searchSemanticTag;
            if (obj.searchSemanticTag !== undefined)
            {
               searchSemanticTag = obj.searchSemanticTag;
            }
            var searchSemanticCategory = this.searchSemanticCategory;
            if (obj.searchSemanticCategory !== undefined)
            {
               searchSemanticCategory = obj.searchSemanticCategory;
            }
            ...
            this._performSearch(
            {
               ...
               searchSemanticTag: searchSemanticTag,
               searchSemanticCategory: searchSemanticCategory
            });
         }
      },
      ...
      _performSearch: function Search__performSearch(args)
      {
         ...
         var searchSemanticTag = YAHOO.lang.trim(args.searchSemanticTag);
         var searchSemanticCategory = YAHOO.lang.trim(args.searchSemanticCategory);
         ...
         function successHandler(sRequest, oResponse, oPayload)
         {
            ...
            this.searchSemanticTag = searchSemanticTag;
            this.searchSemanticCategory = searchSemanticCategory;
         ...
         this.widgets.dataSource.sendRequest(this._buildSearchParams(searchRepository, searchAllSites, searchTerm, searchTag, searchSort, searchSemanticTag, searchSemanticCategory),
         {
       ...
       */
      _buildSearchParams: function Search__buildSearchParams(searchRepository, searchAllSites, searchTerm, searchTag, searchSort, searchSemanticTag, searchSemanticCategory)
      {
         var site = searchAllSites ? "" : this.options.siteId;
         var params = YAHOO.lang.substitute("site={site}&term={term}&tag={tag}&semanticTag={semanticTag}&semanticCategory={semanticCategory}&maxResults={maxResults}&sort={sort}&query={query}&repo={repo}&rootNode={rootNode}",
         {
            site: encodeURIComponent(site),
            repo: searchRepository.toString(),
            term: encodeURIComponent(searchTerm),
            tag: encodeURIComponent(searchTag),
            semanticTag: encodeURIComponent(searchSemanticTag),
            semanticCategory: encodeURIComponent(searchSemanticCategory),
